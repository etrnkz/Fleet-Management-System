        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-emerald-700 leading-tight tracking-tight">Employee Portal</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-emerald-700/10 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wide mb-6">
              ...
              Employee Portal — Haramaya University
            </div>
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-8">
              Manage your assigned trips, track active journeys, report vehicle issues, and stay connected with the transport office — all in one secure employee portal.
            </p>
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-6 space-y-4">
              <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
                ...
                <div>
                  <p className="font-semibold text-gray-900 text-sm">Employee Dashboard</p>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-emerald-100 text-xs">
                ...
                <li><Link href="/login" className="hover:text-white">Employee Login</Link></li>
              </ul>
            </div>
            <div>
