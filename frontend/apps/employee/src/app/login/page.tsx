...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('employee_rememberedEmail')
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (rememberMe) localStorage.setItem('employee_rememberedEmail', email)
      else localStorage.removeItem('employee_rememberedEmail')
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm mt-2 font-medium">
              Use your assigned employee credentials to access the portal.
            </p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-emerald-700 flex-col justify-center px-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="mt-4 text-white/85 text-sm leading-relaxed font-medium">
            View your assigned trips, track active journeys, report vehicle issues, and manage your schedule through this secure employee portal.
          </p>
