    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-emerald-700 leading-tight tracking-tight">Deployment Office Portal</p>
            </div>
          </div>
          ...
          <Link href="/login" className="bg-emerald-700 text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-emerald-800 transition-colors">Sign In</Link>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-emerald-700/10 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wide mb-6">
              <span className="w-1.5 h-1.5 bg-emerald-700 rounded-full" />Deployment Office Portal — Haramaya University
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold text-emerald-700 font-serif leading-tight mb-6">Smart Fleet Control<br />for <span className="text-emerald-600">Haramaya<br />University</span></h1>
            <p className="text-gray-600 text-base leading-relaxed mb-8">Manage your assigned trips, track active journeys, report vehicle issues, and stay connected with the transport office — all in one secure deployment office portal.</p>
            <div className="flex flex-wrap gap-3">
              <Link href="/login" className="bg-emerald-700 text-white px-7 py-3 rounded-lg font-semibold text-sm hover:bg-emerald-800 transition-colors">Login as Deployment Office →</Link>
              <a href="#about" className="border border-emerald-700/30 text-emerald-700 px-7 py-3 rounded-lg font-semibold text-sm hover:bg-emerald-700/5 transition-colors">Learn More</a>
            </div>
          </div>
      ...
      <section id="about" className="py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">HUFMS is a centralized platform designed for efficiency and transparency. It helps track transport logistics across all university departments, digitizing fleet workflows to empower data-driven management of vehicles, trips, and resources.</p>
        </div>
      </section>
      ...
      <footer id="contact" className="bg-emerald-700 text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div><div className="flex items-center gap-2 mb-3"><div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center"><svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20"><path d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM15 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"/><path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1V5a1 1 0 00-1-1H3zM14 7a1 1 0 00-1 1v6.05A2.5 2.5 0 0115.95 16H17a1 1 0 001-1v-5a1 1 0 00-.293-.707l-2-2A1 1 0 0015 7h-1z"/></svg></div><span className="font-bold text-sm">HUFMS</span></div><p className="text-emerald-100 text-xs leading-relaxed">Smart Fleet Control for Haramaya University</p></div>
            <div><h4 className="font-semibold text-sm mb-3">Quick Links</h4><ul className="space-y-2 text-emerald-100 text-xs"><li><a href="#home" className="hover:text-white">Home</a></li><li><a href="#about" className="hover:text-white">About</a></li><li><Link href="/login" className="hover:text-white">Deployment Login</Link></li></ul></div>
            <div><h4 className="font-semibold text-sm mb-3">Legal</h4><ul className="space-y-2 text-emerald-100 text-xs"><li><a href="#" className="hover:text-white">Privacy Policy</a></li><li><a href="#" className="hover:text-white">Terms of Service</a></li></ul></div>
            <div><h4 className="font-semibold text-sm mb-3">Contact</h4><ul className="space-y-1 text-emerald-100 text-xs"><li>Haramaya University</li><li>P.O. Box 138</li><li>Dire Dawa, Ethiopia</li></ul></div>
          </div>
          <div className="border-t border-white/10 pt-6 text-center"><p className="text-emerald-100 text-xs">© 2025 Haramaya University Fleet Management System · <a href="https://haramaya.edu.et" className="hover:text-white underline">haramaya.edu.et</a></p></div>
        </div>
      </footer>
    </div>
  )
