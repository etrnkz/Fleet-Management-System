    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-10 bg-[#F8F9FA]">
        <div className="w-full max-w-md">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <h1 className="text-xl font-bold text-[#1B365D] font-serif tracking-tight">Deployment Office</h1>
              </div>
            </div>
            <h2 className="text-2xl font-bold text-[#1B365D] font-serif tracking-tight">Secure sign in</h2>
            <p className="text-[#424845] text-sm mt-2 font-medium">Use your deployment office credentials to access the portal.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="email" className="block text-xs font-semibold text-[#424845] uppercase tracking-wide mb-2">Email address</label>
              <input type="email" id="email" value={email} onChange={e => setEmail(e.target.value)}
                placeholder="deployment@haramaya.edu.et"
                className="w-full px-4 py-3 border border-[#c1c8c4] rounded-lg focus:ring-2 focus:ring-[#1B365D]/30 focus:border-[#1B365D] outline-none transition-all bg-white"
                required />
            </div>

            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-[#424845] uppercase tracking-wide mb-2">Password</label>
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} id="password" value={password}
                  onChange={e => setPassword(e.target.value)} placeholder="Enter password"
                  className="w-full px-4 py-3 pr-12 border border-[#c1c8c4] rounded-lg focus:ring-2 focus:ring-[#1B365D]/30 focus:border-[#1B365D] outline-none transition-all bg-white"
                  required />
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#1B365D] flex-col justify-center px-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <p className="text-[#D1E1FF] text-xs font-semibold uppercase tracking-[0.2em] mb-4">Official access</p>
