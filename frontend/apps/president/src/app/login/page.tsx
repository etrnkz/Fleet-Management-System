  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (rememberMe) {
        ...
        localStorage.setItem('presidentRememberedUser', JSON.stringify({ email, password, expiry: expiry.toISOString() }))
      } else {
        localStorage.removeItem('presidentRememberedUser')
      }
      ...
      if (role !== 'President') {
        ;['accessToken', 'access_token', 'user'].forEach(k => localStorage.removeItem(k))
    ...
    <div className="min-h-screen flex">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <h1 className="text-lg font-bold text-[#1B3D2F] tracking-tight">President Portal</h1>
              </div>
            </div>
            <h2 className="text-2xl font-bold text-[#1B3D2F] tracking-tight">Secure sign in</h2>
            <p className="text-gray-600 text-sm mt-2">Use your presidential credentials to access the portal.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input id="email" type="email" value={email}
                  ...
                  placeholder="president@haramaya.edu.et"
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link href="/forgot-password" className="text-xs font-semibold text-[#1B3D2F] hover:underline">Forgot password?</Link>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="w-5 h-5 text-[#1B3D2F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#152e22] flex-col justify-center px-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <p className="text-[#D1E1FF] text-xs font-semibold uppercase tracking-[0.2em] mb-4">Executive access</p>
          ...
          <p className="mt-4 text-white/85 text-sm leading-relaxed font-medium">
            Final approval authority for all trip requests, executive oversight of fleet operations, and comprehensive analytics across all university departments.
          </p>
