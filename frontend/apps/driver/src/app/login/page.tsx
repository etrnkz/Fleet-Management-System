    ...
    <div className="min-h-screen flex">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1B3D2F]/30 focus:border-[#1B3D2F] outline-none transition-all bg-white"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1B3D2F]/30 focus:border-[#1B3D2F] outline-none transition-all bg-white"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#1B3D2F] text-white py-3 rounded-lg font-semibold text-sm hover:bg-[#152e22] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#1B3D2F] flex-col justify-center px-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <p className="text-[#1B3D2F] text-xs font-semibold uppercase tracking-[0.2em] mb-4">Driver access</p>
