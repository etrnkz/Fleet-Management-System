        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-[#1B3D2F] leading-tight tracking-tight">Driver Portal</p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-6 space-y-4">
              <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
                ...
                <span className="ml-auto flex items-center gap-1.5 text-xs text-[#1B3D2F] font-medium">
                  <span className="w-1.5 h-1.5 bg-#f0f9f40 rounded-full animate-pulse" />GPS Live
                </span>
              </div>
              {[
                { label: 'Assigned Trips', value: '3', color: 'bg-blue-50 text-blue-700' },
                { label: 'Active Trip', value: '1', color: 'bg-#f0f9f4 text-[#1B3D2F]' },
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-[#1B3D2F] text-sm leading-relaxed">Designed to serve all parts and campuses of Haramaya University for streamlined operations.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-[#1B3D2F] text-sm leading-relaxed">Only authorized personnel with valid credentials can access the system, ensuring data security.</p>
            </div>
          </div>
        </div>
      </section>
              ...
              {['Trip Request Module', 'GPS Tracking System', 'Mobile Platform', 'Notification Service'].map(s => (
                <div key={s} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                  ...
                  <span className="flex items-center gap-1.5 text-xs text-[#1B3D2F] font-medium">
                    <span className="w-1.5 h-1.5 bg-#f0f9f40 rounded-full" />Operational
                  </span>
                </div>
              ))}
            </div>
