  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-[#1B365D] leading-tight">Driver Portal</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-[#1B365D]/10 text-[#1B365D] px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wide mb-6">
              ...
              Driver Portal — Haramaya University
            </div>
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-8">
              Manage your assigned trips, track active journeys, report vehicle issues, and stay connected with the transport office — all in one secure driver portal.
            </p>
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-6 space-y-4">
              <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
                ...
                <div>
                  <p className="font-semibold text-gray-900 text-sm">Driver Dashboard</p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-[#1B365D] font-serif text-center mb-12">Institutional Benefits</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={b.title} className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[#1B365D] mb-2">{b.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-[#D1E1FF] text-sm leading-relaxed">Only authorized personnel with valid credentials can access the system, ensuring data security.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-5">
              <div className="flex gap-4">
                <div className="w-10 h-10 bg-[#1B365D]/10 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <footer id="contact" className="bg-[#1B365D] text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="border-t border-white/10 pt-6 text-center">
            <p className="text-[#D1E1FF] text-xs">
