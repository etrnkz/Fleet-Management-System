        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-[#1B3D2F] leading-tight">Driver Portal</p>
            </div>
          </div>
          ...
          <Link href="/login" className="bg-[#1B3D2F] text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-[#152a47] transition-colors">
            Sign In
          </Link>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/login" className="bg-[#1B3D2F] text-white px-7 py-3 rounded-lg font-semibold text-sm hover:bg-[#152a47] transition-colors">
                Login as Driver →
              </Link>
