    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="home" className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-block bg-emerald-50 text-emerald-700 px-4 py-2 rounded-full text-sm mb-6">
              WELCOME: DRIVER PORTAL
            </div>
            ...
            <div className="flex gap-4">
              <Link href="/login" className="bg-emerald-500 text-white px-8 py-3 rounded-md hover:bg-emerald-600 font-medium">
                Login as Driver →
              </Link>
              <button className="border border-gray-300 text-gray-700 px-8 py-3 rounded-md hover:bg-gray-50 font-medium">
                Learn More
              </button>
            </div>
          </div>
          <div className="relative">
            <div className="bg-gradient-to-br from-emerald-100 to-emerald-50 rounded-2xl p-8 shadow-xl">
              <div className="bg-white rounded-lg p-6 shadow-lg">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-emerald-500 rounded-full"></div>
                  <div>
                    <p className="font-semibold text-gray-900">Fleet Dashboard</p>
                    <p className="text-sm text-gray-500">Real-time monitoring</p>
                  </div>
                </div>
                <div className="h-32 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-lg"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="font-semibold text-gray-900">Dean</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-semibold text-gray-900">High Rank</p>
            </div>
