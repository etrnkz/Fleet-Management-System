  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">System User Role</h2>
            <p className="text-gray-600 text-lg">Authorized access for college deans</p>
          </div>
          <div className="flex justify-center">
            <div className="text-center">
              ...
              <p className="font-bold text-xl text-gray-900">Department Head</p>
              <p className="text-sm text-gray-600 mt-2">Approve trip requests and manage college fleet operations</p>
            </div>
          </div>
        </div>
      </section>
