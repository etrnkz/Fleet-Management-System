...
export default function SettingsPage() {
  ...
  const loadProfile = () => {
    ...
    setFormData({
      ...
      department: parsedData.department || currentUser?.department?.name || currentUser?.department || '',
      college: parsedData.college || currentUser?.college?.name || currentUser?.college || '',
    })
