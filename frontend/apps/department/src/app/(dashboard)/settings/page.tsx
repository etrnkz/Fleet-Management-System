            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Invited employees will receive an email with a temporary password and must complete their profile before making trip requests.
                </p>
              </div>
              ...
              {inviteMode === 'email' ? (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Email Addresses <span className="text-gray-400 font-normal">(separate by comma or new line)</span>
                  </label>
                  <textarea
                    value={inviteEmails}
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                      ...
                      <div className="space-y-1">
                        {inviteResult.failed.map((f) => (
                          <p key={f.email} className="text-xs text-red-700">{f.email}: {f.reason}</p>
                        ))}
                      </div>
                    </div>
                  )}
