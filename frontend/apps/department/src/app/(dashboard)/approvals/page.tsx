...
export default function ApprovalsPage() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div>
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-emerald-600">Trip Requests</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-200">
          ...
          <div className="text-2xl md:text-3xl font-bold text-emerald-800">{stats.approved}</div>
        </div>
          ...
          <div key={request.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="px-4 md:px-6 pb-4 md:pb-6">
              <button
                ...
                className="w-full px-4 py-2 md:py-2.5 bg-emerald-50 text-emerald-800 rounded-lg hover:bg-emerald-100 transition-colors text-xs md:text-sm font-medium"
              >
                View Details
              </button>
            </div>
