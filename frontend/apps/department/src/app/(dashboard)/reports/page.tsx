          ...
          <div className="p-4 md:p-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 md:gap-4">
              ...
              <div className="text-center p-2 md:p-3 bg-emerald-50 rounded-lg">
                ...
                <p className="text-lg md:text-2xl font-bold text-emerald-600">43</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 md:px-6 py-3 md:py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="p-1.5 md:p-2 text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors" title="View">
                        <svg className="w-3.5 h-3.5 md:w-4 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
