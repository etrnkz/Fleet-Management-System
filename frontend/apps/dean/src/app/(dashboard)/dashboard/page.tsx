...
export default function DashboardPage() {
  ...
  const recentActivity = [
    ...
    { id: 3, title: 'New Request Received', subtitle: 'From Prof. Martha G. • Yesterday', color: 'bg-blue-500' },
  ]
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-4 md:p-6 border-b border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <h2 className="text-base md:text-lg font-semibold text-gray-900">College Trip History</h2>
                ...
                currentTrips.map((trip, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 md:px-6 py-3 md:py-4">
                      <span className="inline-block px-2 md:px-3 py-0.5 md:py-1 bg-blue-100 text-blue-700 rounded-full text-[10px] md:text-xs font-medium whitespace-nowrap">
                        {trip.status}
                      </span>
                    </td>
                  </tr>
