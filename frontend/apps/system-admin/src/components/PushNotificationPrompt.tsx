      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-gray-900 mb-1">Enable System Alerts</h3>
            <p className="text-xs text-gray-500 mb-3">Get instant browser notifications for system events and alerts</p>
