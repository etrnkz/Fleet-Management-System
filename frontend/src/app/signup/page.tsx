...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div className="flex flex-col items-center mb-4 sm:mb-6">
              <div className="relative">
                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden bg-gray-200 border-4 border-[#1B3D2F]">
                  {profileImage ? (
                ...
                <label htmlFor="profileImage" className="absolute bottom-0 right-0 bg-[#1B3D2F] text-white p-1.5 sm:p-2 rounded-full cursor-pointer hover:bg-[#152e22] transition-colors">
            ...
            <div>
              ...
              <EmailInput id="email" name="email" value={formData.email} onChange={handleChange}
                placeholder="Enter your email" required
                className="w-full px-4 py-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1B3D2F]/30 focus:border-[#1B3D2F] outline-none transition-all" />
            </div>
              ...
              <>
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ color: '#111827', backgroundColor: '#ffffff' }}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1B3D2F]/30 focus:border-[#1B3D2F] outline-none transition-all text-gray-900 disabled:bg-gray-100 disabled:cursor-not-allowed"
                    required
                  >
            ...
            <div className="flex items-start">
              <input
                ...
                onChange={handleChange}
                className="w-4 h-4 text-[#1B3D2F] border-gray-300 rounded focus:ring-[#1B3D2F] mt-1"
                required
              />
              <label htmlFor="agreeToTerms" className="ml-2 text-sm text-gray-700">
                I agree to the{' '}
                <Link href="/terms" className="text-[#1B3D2F] hover:text-[#152e22]">
                  Terms and Conditions
                </Link>
                {' '}and{' '}
                <Link href="/privacy" className="text-[#1B3D2F] hover:text-[#152e22]">
                  Privacy Policy
                </Link>
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#1B3D2F] text-white py-3 rounded-lg font-medium hover:bg-[#152e22] transition-all duration-300 hover:scale-105 hover:shadow-lg transform disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
            ...
            <div className="text-center text-sm text-gray-600 mt-6">
              ...
              <Link href="/login" className="text-[#1B3D2F] hover:text-[#152e22] font-medium">
                Login
              </Link>
            </div>
          </form>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-br from-[#1B3D2F] to-[#152e22]">
