...
function LandingPageContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-[#1B3D2F] leading-tight tracking-tight">Fleet Management System</p>
            </div>
          </div>
      ...
      {/* Hero */}
      <section id="home" className="bg-gray-50 scroll-mt-16">
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-8">
              One unified portal for all roles — transport staff, drivers, deans, departments, and executives. Sign in once and access your role-specific dashboard automatically.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-6 space-y-4">
              <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
                <div className="w-10 h-10 bg-[#152e22] rounded-full flex items-center justify-center">
                  <span className="text-white text-sm font-bold">HU</span>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 text-sm">Unified Dashboard</p>
                  <p className="text-xs text-gray-400">Role-based access for all staff</p>
                </div>
                <span className="ml-auto flex items-center gap-1.5 text-xs text-[#1B3D2F] font-medium">
                  <span className="w-1.5 h-1.5 bg-[#1B3D2F] rounded-full animate-pulse" />Live
                </span>
              </div>
              {[
                { label: 'Active Portals', value: '8', color: 'bg-blue-50 text-blue-700' },
                { label: 'Roles Supported', value: '10', color: 'bg-[#1B3D2F]/10 text-[#1B3D2F]' },
                { label: 'Single Sign-In', value: '✓', color: 'bg-gray-50 text-gray-700' },
              ].map(s => (
      ...
      <section id="about" className="py-20 scroll-mt-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
            HUFMS is a centralized platform designed for efficiency and transparency. It consolidates all transport operations — from trip requests by employees and departments, through approvals by deans and the president, to allocation by the deployment office and execution by drivers — into one unified portal with role-based access.
          </p>
        </div>
      </section>

      {/* Modules */}
      <section className="bg-gray-50 py-20 scroll-mt-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: 'Fuel Monitoring', desc: 'Track fuel consumption, costs, and efficiency metrics across the fleet.', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
              ...
              { title: 'Reports & Analytics', desc: 'Generate detailed reports on fleet performance, costs, and utilization.', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
            ].map(m => (
      ...
      {/* Support */}
      <section id="support" className="py-20 bg-gray-50 scroll-mt-16">
      ...
      {/* Footer */}
      <footer id="contact" className="bg-[#152e22] text-white py-12 scroll-mt-16">
        <div className="max-w-7xl mx-auto px-6">
