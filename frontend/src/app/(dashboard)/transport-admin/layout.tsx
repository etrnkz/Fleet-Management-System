...
export default function DashboardLayout({
  ...
  return (
    <ThemeProvider storageKey="theme_transport_admin">
        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            <Link 
              ...
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/dashboard')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/dashboard')
            ...
            <Link 
              ...
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/vehicles')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/vehicles')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              href="/transport-admin/tracking" 
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/tracking')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/tracking')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              ...
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/drivers')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/drivers')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              ...
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/trips')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/trips')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              href="/transport-admin/approvals" 
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/approvals')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/approvals')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              href="/transport-admin/fuel" 
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/fuel')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/fuel')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              href="/transport-admin/documents" 
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/documents')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/documents')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              href="/transport-admin/reports" 
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/reports')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/reports')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              href="/transport-admin/feedback" 
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/feedback')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/feedback')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
            ...
            <Link 
              href="/transport-admin/notifications" 
              onClick={(e) => {
                handleNavigation(e, '/transport-admin/notifications')
                setSidebarOpen(false)
              }}
              className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors ${
                isActive('/transport-admin/notifications')
                  ? 'text-emerald-700 font-bold border-l-4 border-emerald-700'
                  : 'text-gray-600 hover:text-emerald-700 hover:bg-gray-100'
              }`}
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <h1 className="text-sm sm:text-base md:text-xl font-bold text-gray-900 transition-colors duration-300 truncate">
                {pathname === '/transport-admin/dashboard' && 'Dashboard Overview'}
                {pathname === '/transport-admin/drivers' && 'Drivers'}
                {pathname === '/transport-admin/vehicles' && 'Vehicles'}
                {pathname === '/transport-admin/tracking' && 'Live Tracking'}
                {pathname === '/transport-admin/trips' && 'Trips'}
                {pathname === '/transport-admin/approvals' && 'Pending Approvals'}
                {pathname === '/transport-admin/fuel' && 'Fuel Management'}
                {pathname === '/transport-admin/documents' && 'Documents'}
                {pathname === '/transport-admin/reports' && 'Reports'}
                {pathname === '/transport-admin/feedback' && 'Feedback'}
                {pathname === '/transport-admin/settings' && 'Settings'}
                {pathname === '/transport-admin/notifications' && 'Notifications'}
              </h1>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 border-b border-gray-200 bg-[#1B3D2F]/10">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setShowProfileModal(false)} className="text-gray-400 hover:text-gray-600 transition-colors" aria-label="Close profile modal">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                  </svg>
                </button>
