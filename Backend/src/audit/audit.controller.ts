...
export class AuditController {
  ...
  @ApiOperation({
    ...
    description:
      'Get paginated audit logs with optional filtering by user, action, entity type, and date range',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Get comprehensive statistics about audit logs and system activity',
  })
  @ApiQuery({
    name: 'startDate',
    required: false,
