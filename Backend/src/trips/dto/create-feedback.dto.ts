import { IsEnum, IsString, IsOptional, IsBoolean, IsArray, Min, Max, IsInt } from 'class-validator';
...
export class CreateFeedbackDto {
  ...
  @ApiPropertyOptional({ 
    example: 'Great trip, driver was very professional and the vehicle was clean.',
